	...
	@Autowired
	 ...
	 public ResponseEntity<Employee> addEmployee(@RequestBody Employee employee) {
	     ...
	     if (optionalDepartment.isPresent()) {
	         // Department found, set it to the employee
	         ...
	         // Create a new entry in the department table
//	         Department newDepartment = new Department();
//	         newDepartment.setName("New Department"); // Set the name of the new department
//	         departmentRepository.save(newDepartment);
	         
	         return ResponseEntity.ok().body(savedEmployee);
	     } else {
	         // Department not found, return a not found response
	         return ResponseEntity.notFound().build();
	     }
	 }
